...
`define OPCODE_BUB 4'd11

`define OP_ADD 4'b0000
`define OP_BNE 4'b0001
`define OP_BLZ 4'b0010
`define OP_BGZ 4'b0011
`define OP_BEQ 4'b0100
`define OP_TCP 4'b0101
`define OP_SUB 4'b0110
`define OP_IDA 4'b0111
`define OP_IDB 4'b1000
`define OP_NOT 4'b1001
`define OP_AND 4'b1010
`define OP_OR  4'b1011
`define OP_LRS 4'b1100
`define OP_ARS 4'b1101
`define OP_LLS 4'b1110
`define OP_ALS 4'b1111


`define INST_BUB 16'hb000
